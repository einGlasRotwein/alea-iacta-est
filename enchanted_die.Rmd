...
enchant.die <- function(nrolls, magic_numbers = c(1, 2), die_outcomes = 1:6) {
  ...
  if (sum(!magic_numbers %in% die_outcomes) > 0) {
    stop("Woah there! You want to enchant at least one die outcome that your die cannot possibly roll! Per default, the die rolls 1:6. Specify any other outcomes via the argument die_outcomes.")
  }
